function createWCTFactory(base, listData) {
    return {
        listData: listData,
        base: base,
...
function getWovenCanvasTFactory() {
var listData = [
...
['639','/tbc/639.jpg','Black','12','30.5','','','M',''],
...
['690','/tbc/690.jpg','Black','12','33','','','',''],
    ...
    return createWCTFactory('/products/artwear/wc/', listData)
}
