...
wovencanvas.tshirt.prodData = {
	...
	sizes: ["S", "M", "L", "XL", "XXL"],
	description: '<p>A piece of wearable art! Our P.F.I. T-Shirt with a <strong>numbered</strong> Woven Canvas makes the perfect gift for that unique individual.</p><p>The canvas is made from rare, collectible, vintage Tangail sari borders. Hand woven by Bengali master artisans, Tangail saris feature intricate handloom techniques that can require days of work to create a few centimeters of cloth.</p><p>The canvas creation process is a meditation for me. I start with hundreds of borders, trying different motifs, folding and unfolding, pleating and playing, looking for a harmonious flow of colour and form.</p><p>I have been collecting <a href="/journey/treasuretrove.html">these borders for over 20 years</a>, and I now have thousands of unique pieces. Recently, I found <a href="/tangailcollage.html">an elegant way</a> to share them with you as individually numbered woven canvases, showcased on 100% cotton, unisex T-shirts.</p><p>Along with your T-shirt, you will receive one of our gift bags: a delicate transparent cotton organza envelope with a mother-of-pearl button closure, making it a perfect gift item!</p>',
	garmentDetails: '',
};
