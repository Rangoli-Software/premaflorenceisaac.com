...
function createVBComponentFactory(prodInfo, dimensioner, sizer, catalog) {
    ...
    return createProductComponentFactory(prodInfo, dimensioner, sizer, relatedviewer, navHelper, "", "Size");
}
...
const vb_catalog = {
    ...
    shirts: ['ANGKRT1601Kh', 'KOHKRT1601Kh', 'MAVKRT1601Kh', 'NARKRT1601Kh','MNHTST2016SP'],
    pants: ['PNDPNT1601Kh', 'UBDPNT1601Kh','MNHTPT2018SP'],
