...
function createFMProdCompFactory(prodInfo, dimensioner, catalog, html, carousel, items, sections) {
    ...
    var relatedviewer = createStoryViewer('Background', items, sections, 2);
    var levels = [{
        title: 'Shop',
        url: '/shop.html'
    }, {
...
function renderProductDetails(summary, detailsHTML, washcareHTML, shippingInfoHTML) {
    var res= '<section class="pt-3"><div class="container"><div class="row"><div class="col-12"><div class="nav nav-tabs nav-overflow justify-content-start justify-content-md-center border-bottom">';
    if ( summary !== null ) {
